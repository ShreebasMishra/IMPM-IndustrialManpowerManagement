...
<%!
   ...
   ResultSet rs1,rs2;
   String EmployeeId,EmployeeName[],Gender[],Department[],ShiftName[],EndTime[];
   int i;
...
<form name="f1" action = "impm_attendanceouts.jsp" method = "GET" >
<center>
<h1>Attendance Register-[Out]</h1>
...
<td>Out Time:</td>
<td><input type="time" name="tmeOutTime"></td>
</tr>
</tr>
</table>

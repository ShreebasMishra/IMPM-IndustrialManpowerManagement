...
%>
<center>
<h2>EMPLOYEE INFORMATION[Department]</h2>
</center>
<blockquote>
...
try{
	 ...
	 Department=request.getParameter("txtDeptName");
	 rs=stmtview.executeQuery("select*from impm_tblemployee where department='"+Department+"'");
	 slno=1;
	 while(rs.next()){
